BT-300 Control Library Package
                                                  Seiko Epson Corporation Sep/2017

■ Summary of SDK Functions
This library enables Android Apps to control BT-300's display and sensors.
 - 2D / 3D switching for display and display Toast view.
 - Setting/Getting display brightness
 - ON/OFF switching for display mute, getting status
...
■ Contents
 - BT300Ctrl.jar     Library
 - BT300Sample.zip   Sample App project

■ How to use this library
Please refer the developer's guide for detail.

■ How to use the sample app project
Expand BT300Sample.zip.
Specify the each project folder from [File] [Open] of the Android Studio.

■ Sample Name and Functions
 - Sample Display Control : 2D/3D switching, Display Mute, Brightness control
...
■ Change log
Oct 2016 New
Nov 2016 Added new sample application projects.
Feb 2017 Added new sample application projects.
